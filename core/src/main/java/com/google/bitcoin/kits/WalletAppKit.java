 ...
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV einsteiniumj app. Instantiate it with a directory
=======
...
<<<<<<< HEAD:core/src/main/java/com/google/bitcoin/kits/WalletAppKit.java
 * It is to make it easier to fit einsteiniumj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing einsteiniumj
=======
...
<<<<<<< HEAD:core/src/main/java/com/google/bitcoin/kits/WalletAppKit.java
     * block sync faster for new users - please refer to the documentation on the einsteiniumj website for further details.
=======
