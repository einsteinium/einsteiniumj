 ...
 * <p>To learn more about this class, read <b><a href="http://code.google.com/p/einsteiniumj/wiki/WorkingWithTheWallet">
 ...
 * other objects, see the <a href="http://code.google.com/p/einsteiniumj/wiki/GettingStarted">Getting started</a> tutorial
 * on the website to learn more about how to set everything up.</p>
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of einsteiniumj,
=======
